 ...
 */
public class RequisitionPgerDetailByPending extends BaseDetailPager {
    ...
    public RequisitionPgerDetailByPending(Activity activity) {
        super(activity);
    }

    @Override
    public View initView() {
        View view = View.inflate(mActivity, R.layout.pager_requisition_detail_by_pending, null);
