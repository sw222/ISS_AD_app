 ...
 */
public class RequisitionPgerDetailByWait extends BaseDetailPager {
    ...
    public RequisitionPgerDetailByWait(Activity activity) {
        super(activity);
    }

    @Override
    public View initView() {
        View view = View.inflate(mActivity, R.layout.pager_requisition_detail_by_wait, null);
