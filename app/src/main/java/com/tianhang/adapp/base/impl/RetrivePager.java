 ...
 *
 */
public class RetrivePager extends BasePager implements
    ...
    public RetrivePager(Activity activity) {
        super(activity);
        //mNewsTabDataList = newsMenuBean.children;

    }
    public RetrivePager(Activity activity, NewsMenuBean newsMenuBean) {
        super(activity);
        //mNewsTabDataList = newsMenuBean.children;
    ...
    public void initViews() {
        Log.i("tianhang", "retrive--->initView--->start");
        super.initViews();
        View view = View.inflate(mActivity, R.layout.pager_retrive, null);
        ViewUtils.inject(this, view); // 把当前的View对象注入到xUtils框架中
        mRootView = view;
        Log.i("tianhang", "retrive--->initView--->end");
    }

    @Override
    public void initData() {
        Log.i("tianhang", "retrive--->initData--->start");
        ...
        DetailPagerList.add(new RetrivePgerDetailByItem(mActivity));
        DetailPagerList.add(new RetrivePgerDetailByDepa(mActivity));
        tabItems = new ArrayList<String>();
        tabItems.add("Item");
        tabItems.add("Department");
